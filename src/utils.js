...
export function checkStatus(response) {
  ...
  // Not acceptable (406)
  if (response.status === httpStatus.NOT_ACCEPTABLE) { // eslint-disable-line functional/no-conditional-statements
  ...
  if (response.status === httpStatus.LOCKED) { // eslint-disable-line functional/no-conditional-statements
